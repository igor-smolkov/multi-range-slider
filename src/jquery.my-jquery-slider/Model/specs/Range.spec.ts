...
describe('Диапазон', () => {
  ...
  it('Текущее значение должно быть равно 14', () => {
    const testValue = 14;
    let range: IRange;
    // - действие
  ...
  it('Текущее значение должно быть равно минимальному, когда меньше минимума', () => {
    let range: IRange;
    // - действие
  ...
  it('Текущее значение должно быть равно максимальному, когда больше максимума', () => {
    let range: IRange;
    // - действие
  ...
  it('Минимум должен быть установлен в 16', () => {
  ...
  it('Минимум не должен быть установлен, если он больше максимума', () => {
  ...
  it('Максимум должен быть установлен в 70', () => {
    const range: IRange = new Range();
  ...
  it('Максимум не должен быть установлен, если он меньше минимума', () => {
    const range: IRange = new Range({ min: 10, max: 20 });
    const oldMax = range.getMax();
    const testValue = 5;
    // - действие
